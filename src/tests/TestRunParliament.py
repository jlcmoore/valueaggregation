...
class TestRunParliament(unittest.TestCase):
    ...
    def test_condorcet(self):
        ...
        # max int game
        outcomes = {
            "1": {"A": -sys.maxsize, "B": 0, "C": sys.maxsize},
        ...
        # infinitesimal game
        outcomes = {
            "1": {"A": -1 / sys.maxsize, "B": 0, "C": 1 / sys.maxsize},
    ...
    def test_collaborative_three_player_two_action(self):
        outcomes = {"1": {"A": 1, "B": -1, "C": 1}, "2": {"A": -1, "B": 1, "C": 1}}
    ...
    def test_collaborative_case_fails(self):
        ...
        gameState = pm.ProportionalChancesGameState(
            {"A": 0.4, "B": 0.3, "C": 0.3}, action_agent_outcomes
        )
        result = pm.run_expectimax(gameState)
        self.assertIsNone(result)
...
class TestRunParliamentVote(unittest.TestCase):
    ...
    def test_zero_sum_two_player(self):
        ...
        gameState = pm.VoteGameState({"A": 0.5, "B": 0.5}, outcomes)
        result = pm.run_expectimax(gameState)
        self.assertIsNone(result)
